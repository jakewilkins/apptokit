...
module Apptokit
  class UserToken
    def self.generate(auto_open: true)
      new(auto_open: auto_open).tap {|t| t.generate}
    end
    ...
    def initialize(installation_id: nil, auto_open: true)
    ...
    def generate
      ...
      token_info = exchange_code_for_token(callback_server.oauth_code)
